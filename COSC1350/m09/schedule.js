...
/*
The schedule.js file contains the following arrays and data:

gameDates—the dates of the 23 games played by the team

gameOpponents—the opponent on each of those 23 game days

gameLocations—whether the game was at home (“h”) or away (“a”)

runsScored—the number of runs the Tipton Turbines scored in the game

runsAllowed—the number of runs scored by their opponents

gameInnings—the number of innings played in the game

gameResults—the result of game: “W” (a win for Tipton), “L” (a loss), 
“S” (the game was suspended due to weather),
 or “P” (the game was postponed to a later date due to weather.)
